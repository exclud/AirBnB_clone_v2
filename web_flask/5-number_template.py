...
def c_route(text):
    """
    Renders "C " followed by the value of the
...
def python_route(text):
    """
    Renders "Python " followed by the value of the
    text variable, replacing underscores with spaces.
    """
...
def number_template(n):
    """
    Renders an HTML page displaying the number in an H1 tag, if n is an integer.
    """
